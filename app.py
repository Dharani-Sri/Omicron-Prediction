...
radio_options = ["Daily Cases","Correlation","Timestamp","Chloropleth Maps"]
...
def cmap1():
    statewise = pd.read_csv('/Users/USER/statewise_cases.csv')
...
def main():
    ...
    if mode == "Model Prediction":
        ...
        model_predictions = pd.read_csv('/Users/USER/file1.csv')
